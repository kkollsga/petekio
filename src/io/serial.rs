...
//! stays readable regardless of bincode defaults — the same discipline any
//! versioned on-disk format applies. Element DTOs are positional, so a struct-layout change is a
